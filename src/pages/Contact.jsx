...
function Contact() {
  return (
    ...
    <div className="container-fluid my-5 contact">
      ...
      <div className="row p-lg-5 p-md-3 p-sm-3 mx-auto" style={{height:'100%'}}>
        
        <div className="col-lg-6 col-md-6 col-sm-12 col-12 order-md-1 order-2 p-3" >
        ...
        <div className="row d-flex align-content-between " >
            ...
            <div className="col-md-11 col-10  d-flex flex-column align-items-start ">
              <p >Location</p>
        ...
        <div className="col-lg-6 col-md-6 col-sm-12 col-12 order-md-2 order-1 p-3" >
